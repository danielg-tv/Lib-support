...
The Trading Platform install helper also copies `broker-sample/dist/bundle.js` into `third_party/tradingview/broker-sample/dist/bundle.js` when the installed package contains it.
