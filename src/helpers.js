...
const RESOLUTION_SPECS = Object.freeze({
  "1":   { interval: "1m",  aggregate: 1, streamType: "kline", streamInterval: "1m"  },
  "2":   { interval: "1m",  aggregate: 2, streamType: "trade"                         },
  "3":   { interval: "3m",  aggregate: 1, streamType: "kline", streamInterval: "3m"  },
  "4":   { interval: "1m",  aggregate: 4, streamType: "trade"                         },
  "5":   { interval: "5m",  aggregate: 1, streamType: "kline", streamInterval: "5m"  },
  "10":  { interval: "5m",  aggregate: 2, streamType: "trade"                         },
  "15":  { interval: "15m", aggregate: 1, streamType: "kline", streamInterval: "15m" },
  "30":  { interval: "30m", aggregate: 1, streamType: "kline", streamInterval: "30m" },
  "60":  { interval: "1h",  aggregate: 1, streamType: "kline", streamInterval: "1h"  },
  "90":  { interval: "30m", aggregate: 3, streamType: "trade"                         },
  "120": { interval: "2h",  aggregate: 1, streamType: "kline", streamInterval: "2h"  },
  "180": { interval: "1h",  aggregate: 3, streamType: "trade"                         },
  "240": { interval: "4h",  aggregate: 1, streamType: "kline", streamInterval: "4h"  },
  "360": { interval: "6h",  aggregate: 1, streamType: "kline", streamInterval: "6h"  },
  "480": { interval: "8h",  aggregate: 1, streamType: "kline", streamInterval: "8h"  },
  "720": { interval: "12h", aggregate: 1, streamType: "kline", streamInterval: "12h" },
  "1D":  { interval: "1d",  aggregate: 1, streamType: "kline", streamInterval: "1d"  },
  "3D":  { interval: "3d",  aggregate: 1, streamType: "kline", streamInterval: "3d"  },
  "1W":  { interval: "1w",  aggregate: 1, streamType: "kline", streamInterval: "1w"  },
  "1M":  { interval: "1M",  aggregate: 1, streamType: "kline", streamInterval: "1M"  },
});
