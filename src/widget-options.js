...
export function createWidgetOptions({
  ...
  return {
    ...
    enabled_features: unique([...SHARED_ENABLED_FEATURES, ...enabledFeatures]),
    disabled_features: unique([...SHARED_DISABLED_FEATURES, ...disabledFeatures]),
    overrides: {
...
export function createAdvancedChartOptions({
  ...options
} = {}) {
...
export function createTradingPlatformOptions({
  ...
  return createWidgetOptions({
    ...
    enabledFeatures: [...TRADING_PLATFORM_ENABLED_FEATURES, ...enabledFeatures],
    disabledFeatures : [ ... TRADING_PLATFORM_DISABLED_FEATURES, ...disabledFeatures],
  });
}
