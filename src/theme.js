...
const customCSS = `
			@font-face {
				...
				src: url('http://localhost:3000/src/fonts/NanumBarunGothic.otf') format('opentype'); 
				font-weight: normal;
				font-style: normal;
			}
			...
			/* Target the step-size button */
			button[data-qa-id="dom-price-step-dropdown-button"] {
				pointer-events: none !important; /* Disables clicking */
				background: transparent !important; /* Removes button hover background */
			}

			/* Hide the dropdown caret/arrow SVG so it just looks like plain text */
