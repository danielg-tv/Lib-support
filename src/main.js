...
var widget = (window.tvWidget =  new TradingView.widget({
	  symbol: 'Binance:ETH/USDT',                     // Default symbol pair
  ...
  broker_factory: function (host) {
    ...
    time_frames: [
    { text: ytdLabel, resolution: "D", description: "Year to Date", title: "YTD" },
    { text: "6M", resolution: "D", description: "Last 6 Months"},
    { text: "1Y", resolution: "D", description: "Last 1 Year" },
    { text: "8m", resolution: "1D", description: "8 Month" },
    { text: "1d", resolution: "5", description: "Day" },
	  ],	
  ...
  widget.headerReady().then(function () {
    ...
    button.addEventListener("click", function () {
        window.widget.activeChart().removeAllStudies();
        const symbol_set = widget.activeChart().symbol();
        window.widget.activeChart().removeAllShapes(),
        window.widget.setLayout("s"),
        window.widget.activeChart().setSymbol(symbol_set),
        window.widget.activeChart().resetData()
    });
  });
